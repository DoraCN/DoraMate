...
internal static class NativeExports
{
    ...
    {
        return OperatorEntrypoint<MyOperator>.InitOperator();
    }
    ...
    {
        return OperatorEntrypoint<MyOperator>.DropOperator(operatorContext);
    }
    ...
    {
        return OperatorEntrypoint<MyOperator>.OnEvent(
            eventPtr,
            sendOutputPtr,
            operatorContext);
    }
