...
/// <summary>
/// Helper methods for validating common Arrow schema and <see cref="RecordBatch"/> expectations.
/// </summary>
public static class ArrowSchemaValidation
{
        ...
        out string? error)
    {
        ...
        var actualTimezone = timestampType.Timezone;
        ...
        out string? error)
    {
        ...
        {
            error =
                $"Expected field '{expectedFieldName}' to use precision {expectedPrecision} but got {decimalType.Precision}.";
            return false;
        }
        ...
        out string? error)
    {
        ...
        {
            error =
                $"Expected list field '{expectedFieldName}' to use value field '{expectedValueFieldName}' but got '{listType.ValueField.Name}'.";
            return false;
        }
        ...
        {
            error =
                $"Expected list field '{expectedFieldName}' to use value type {expectedValueTypeId} but got {listType.ValueDataType.TypeId}.";
            return false;
        }
        ...
        out string? error)
    {
        ...
        {
            error =
                $"Expected map field '{expectedFieldName}' to use key field '{expectedKeyFieldName}' but got '{mapType.KeyField.Name}'.";
            return false;
        }
        ...
        {
            error =
                $"Expected map field '{expectedFieldName}' to use value field '{expectedValueFieldName}' but got '{mapType.ValueField.Name}'.";
            return false;
        }
        ...
        {
            error =
                $"Expected map field '{expectedFieldName}' to use key type {expectedKeyTypeId} but got {mapType.KeyField.DataType.TypeId}.";
            return false;
        }
        ...
        {
            error =
                $"Expected map field '{expectedFieldName}' to use value type {expectedValueTypeId} but got {mapType.ValueField.DataType.TypeId}.";
            return false;
        }
        ...
        out string? error)
    {
        ...
        {
            error =
                $"Expected struct field '{expectedFieldName}' to contain {expectedChildFieldNames.Count} child fields but got {structType.Fields.Count}.";
            return false;
        }
        ...
        for (var childIndex = 0; childIndex < expectedChildFieldNames.Count; childIndex++)
        {
            ...
            {
                error =
                    $"Expected struct field '{expectedFieldName}' child {childIndex} to be '{expectedChildFieldName}' but got '{actualField.Name}'.";
                return false;
            }
            ...
            {
                error =
                    $"Expected struct field '{expectedFieldName}' child '{actualField.Name}' to have type {expectedChildTypeId} but got {actualField.DataType.TypeId}.";
                return false;
            }
        }
