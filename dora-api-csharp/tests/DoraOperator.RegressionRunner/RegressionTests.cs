...
public sealed class RegressionTests
{
    ...
    public void TelemetryStartsChildActivityFromDoraTraceContext()
    {
        ...
        {
            ShouldListenTo = source => source.Name == "DoraMate.DoraOperator",
            Sample = (ref ActivityCreationOptions<ActivityContext> _) => ActivitySamplingResult.AllDataAndRecorded,
        };
        ActivitySource.AddActivityListener(listener);

        const string context = "traceparent:00-4bf92f3577b34da6a3ce929d0e0e4736-00f067aa0ba902b7-01;";
        using var activity = DoraTelemetry.StartActivityFromContext(context, "test-operator");
    ...
    public void TelemetryTreatsInvalidContextAsRootActivity()
    {
        ...
        using var activity = DoraTelemetry.StartActivityFromContext("traceparent:not-a-valid-context;", "test-operator-root");
