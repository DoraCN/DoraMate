...
namespace CSharpNodeOperatorArrowDataflow;

internal static class RichArrowContract
{
    ...
    public static RecordBatch CreateRecordBatch()
    {
        var schema = new Schema.Builder()
            .Field(new Field("name", new StringType(), nullable: false, EmptyMetadata))
        ...
        return new RecordBatch(schema, columns, length: ExpectedNames.Length);
    }
}
